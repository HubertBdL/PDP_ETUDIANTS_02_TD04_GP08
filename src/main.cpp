...
const char* wifi_ssid = "iPhone de Paul (2)";
const char* wifi_password = "04052019";
...
const char* client_id = "TD04_GP08";
const char* mqtt_temp = "TD04_GP08/temp";
const char* mqtt_hum = "TD04_GP08/relhum";
...
void setup() {
  ...
  mqtt_client.connect("27cc61dbaffc4da08cd0081cabd8cf01.s2.eu.hivemq.cloud","TD04_GP08","ocresse123"
  );
